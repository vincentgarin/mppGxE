#########################
# QTL_effects_oneS_1QTL #
#########################

#' MPP GxE one stage QTL genetic effects for a single QTL
#'
#' Compute MPP GxE one stage QTL genetic effects of a single QTL position given
#' a number of positions set as cofactors.
#'
...
QTL_effects_oneS_1QTL <- function(plot_data, mppData, trait, Q.eff = "cr",
  ...
  mod <- QTLModelQeff_oneS_1QTL(plot_data = plot_data, mppData = mppData,
